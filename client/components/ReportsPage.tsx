    ...
    try {
      ...
      const mockReportData: ReportData = {
        ...
        topVendors: [
          ...
          {
            vendorName: "GHI Cleaning Services",
            count: 12,
            totalAmount: 180000,
          },
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Generate comprehensive reports on transaction activities and
          performance
        </p>
      </div>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="pending_on_agent">
                    Pending on Agent
                  </SelectItem>
            ...
            {user?.role === "admin" && (
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFilters((prev) => ({ ...prev, societyId: value }))
                  }
                >
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="society2">
                      Sunrise Heights Society
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Breakdown of transactions by current status
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Vendors with the highest transaction volumes
              </CardDescription>
            </CardHeader>
            <CardContent>
