        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex gap-2">
              {user?.role === "admin" && (
                <Button
                  onClick={() => (window.location.href = "/admin/societies")}
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          {user.role === "society_user" && (
            <>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {currentStats.pendingTransactions || 0}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Awaiting review
                  </p>
          ...
          {user.role === "agent" && (
            <>
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {currentStats.assignedTransactions || 0}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Total assigned
                  </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {user.role === "admin" &&
                  (currentStats.totalTransactions || 0) -
                    (currentStats.pendingTransactions || 0)}
                {user.role === "society_user" &&
                  (currentStats.completedTransactions || 0)}
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {user.role === "agent"
                  ? currentStats.avgProcessingTime || "N/A"
                  : "98%"}
              </div>
              <p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Transaction #12345 by Society A - 2 hours ago
                  </p>
                </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Transaction #12340 marked as completed - 4 hours ago
                  </p>
                </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Transaction #12338 needs additional info - 6 hours ago
                  </p>
                </div>
